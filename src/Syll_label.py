...
uvwl1 = [u'\u0259', "u", "E", "A", "O", "M", "J", "N", u'i', u'a', "U", "I", u'!', u'#', u'%', u'(', u')', u'_', u'+', u'=', u'1', u'`']
long_vowel = ["E", "A", "O", "M", "J", "N", "U", "I"]
short_vowel = ["i", "o", "u", u'\u0259']
uc = [u'p', u'b', u't', u'd', u'\u0288', u'\u0256', u't\u0283', u'd\u0292', u'k', u'g', u'q', u'm', u'n', u'\u0273', u'f', u's', u'z', u'\u0283', u'x', u'\u0263', u'h', u'\u028b', u'j', u'r', u'l', u'\u023f', u'\u027d', u'\u0272', u'\u014b']
...
def Labeling(entries):
	...
	for i in range(len(indexvowelsnew) - 1):
		if i <= len(newpos)-1 and i <= len(countweight)-1:
		...
		if (countweight[len(countweight) - 1] == 2 and len(hindi_output1) > indexvowelsnew[len(indexvowelsnew) - 1] + 2 and hindi_output1[len(hindi_output1) - 1] != "X"):
			if hindi_output1[indexvowelsnew[len(indexvowelsnew) - 1] - 1] == ".":
				hindi_output1[indexvowelsnew[len(indexvowelsnew) - 1] - 1] = "&"
			elif hindi_output1[indexvowelsnew[len(indexvowelsnew) - 1]] == ".":
				hindi_output1[indexvowelsnew[len(indexvowelsnew) - 1]] = "&"
	...
	hindi_output1 = list(filter(bool, hindi_output1))
	...
	if (len(hindi_output1) and len(labelindexvowels) > 0 and len(hindi_output1) == labelindexvowels[len(labelindexvowels) - 1] + 2):
		labelcountweight[len(labelcountweight) - 1] += 1
	if (len(hindi_output1) and len(labelindexvowels) > 0 and len(hindi_output1) >= labelindexvowels[len(labelindexvowels) - 1] + 3):
	...
	if len(labelcountweight) > len(labelnewpos):
		...
		for i in range(len(labelcountweight) - 1):
			...
			if (labelcountweight[i] <= labelcountweight[i + 1]):
				...
				for j in range(labelnewpos[i], labelnewpos[i] + 4):
					if (j<=len(hindi_output1)-1 and hindi_output1[j] == "X"):
						k = j
					for p in range(4):
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and (hindi_output1[k + 1] == p_class[p] or hindi_output1[k + 1] == u'\u028b')):
							hindi_output1[k] = "m"
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and (hindi_output1[k + 2] == p_class[p] or hindi_output1[k + 2] == u'\u028b')):
							hindi_output1[k] = "m"
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 1] == t_class[p]):
							hindi_output1[k] = "n"
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 2] == t_class[p]):
							hindi_output1[k] = "n"
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 1] == k_class[p]):
							hindi_output1[k] = u'\u014b'
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 2] == k_class[p]):
							hindi_output1[k] = u'\u014b'
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 1] == c_class[p]):
							hindi_output1[k] = "n"
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 2] == c_class[p]):
							hindi_output1[k] = "n"
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 1] == T_class[p]):
							hindi_output1[k] = "n"
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and hindi_output1[k + 2] == T_class[p]):
							hindi_output1[k] = "n"
						if (k+1<=len(hindi_output1)-1 and hindi_output1[k] == "X" and (hindi_output1[k + 1] == "s" or hindi_output1[k + 1] == "S")):
							hindi_output1[k] = "n"
						if (k+2<=len(hindi_output1)-1 and hindi_output1[k] == "X" and (hindi_output1[k + 2] == "s" or hindi_output1[k + 2] == "S")):
							hindi_output1[k] = "n"
	...
	if (countv > 1):
		for i in range(4):
			...
			if (hindi_output1[len(hindi_output1) - 2] == "X" and (hindi_output1[len(hindi_output1) - 1] == p_class[i] or hindi_output1[len(hindi_output1) - 1] == u'\u028b')):
